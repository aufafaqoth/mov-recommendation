...
int main()
{
    ...
    if (umur < 6){
        cout << "Belum cukup umur untuk menonton film" << endl;
    }
    ...
    switch(pilih){
        ...
        case 2:
            ...
            cout << "hanya itu, karakter yang walaupun hanya seorang bayi tetapi berlagak seperti layaknya boss, bahkan kakaknya sendiri \n";
    ...
    cout<<"Mau rekomendasi lagi? Ketik (Y) jika ingin, ketik (T) jika tidak : ";
    cin>> out;
    cout << endl;
    }   while(out=='Y'||out=='y');
        cout<<"Terima Kasih Telah Membaca Rekomendasi Kami :D"<<endl;
    return 0;
}
